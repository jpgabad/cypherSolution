...
// master.add(devices("#line1"), 's+1.1')
master.add(bars("#bar1"), 's+1.1')
master.add(bars("#bar2"), 's+1.1')
master.add(bars("#bar3"), 's+1.1')
master.add(bars("#bar4"), 's+1.1')
master.add(bars("#bar5"), 's+1.1')
// master.add(lines("#leaves"), 's+1.1')
